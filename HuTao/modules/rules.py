...
from HuTao import Config


@app.on_message(COMMAND_HANDLER("rules") & filters.group)
...
@app.on_message(COMMAND_HANDLER("setrules") & user_admin)
...
@app.on_message(
    COMMAND_HANDLER(["pmrules", "privaterules"]) & user_admin,
)
async def priv_rules(_, m: Message):
    ...
    if len(m.text.split()) == 2:
        ...
        await m.reply_text(text="Please check help on how to use this this COMMAND_HANDLER.")

    return


@app.on_message(COMMAND_HANDLER("clearrules") & user_admin)
